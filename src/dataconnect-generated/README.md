...
// Variables can be defined inline as well.
const { data } = await upsertEternalMemory({ id: ..., type: ..., content: ..., tags: ..., hashLock: ..., consolidated: ..., });
...
// Variables can be defined inline as well.
const ref = upsertEternalMemoryRef({ id: ..., type: ..., content: ..., tags: ..., hashLock: ..., consolidated: ..., });
